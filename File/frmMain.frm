...
Begin VB.Form frmMain 
   Caption         =   "Uno Game 2.0 by Aris Buenaventura"
   ClientHeight    =   6330
   ClientLeft      =   165
   ClientTop       =   855
   ClientWidth     =   9420
   ...
   Begin MSComctlLib.ImageList imlToolbarIcons 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":38A8
            Key             =   "open"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":4182
            Key             =   "tooltip"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":4A5C
            Key             =   "save"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":5336
            Key             =   "hint"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":5C10
            Key             =   "help"
         EndProperty
      EndProperty
   End
...
Private Sub Form_Load()
    ...
    For i = 0 To picTrackWin.ScaleHeight Step 4
        picTrackWin.Line (0, i)-(picTrackWin.ScaleWidth, i), &HECECEC
    Next i
    
    Set picTrackWin.Picture = picTrackWin.Image
...
Private Sub Form_Unload(Cancel As Integer)
    If MsgBox("Are you sure you want to exit?", vbQuestion Or vbOKCancel, "Exit") = vbOK Then
        ...
        Call SaveSettings
        SendMessage HelpWinHwnd, WM_CLOSE, 0&, 0&
        End
    Else
        Cancel = True
    End If
...
Private Sub TrackCard(Card As Object)
    If Card.Face = uno_FCUp Then
        ...
        cx = (picTrackWin.ScaleWidth - CardW) / 2 - 1
        cy = (picTrackWin.ScaleHeight - CardH) / 2 - 1
            
        picTrackWin.Line (cx + 2, cy + 2)- _
                         (cx + CardW + 2, cy + CardH + 2), &H0, BF
        picTrackWin.PaintPicture Card.Picture, cx, cy, CardW, CardH
...
Private Sub GameStart()
    ...
    If EndGame Then
        If Not IsDone Then
            ...
            If frmScore.IsWinner And Not mnuGameShowDemo.Checked Then
                ' play animation
                Dim i    As Integer
                Dim Temp As Object
                Dim Cntr As Integer
